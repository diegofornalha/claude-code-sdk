...
class ClaudeCodeSessionManager:
    ...
    SESSION_TIMEOUT_MINUTES = 60  # 60 minutos de timeout de sessão
    CLEANUP_INTERVAL_MINUTES = 15  # Limpeza a cada 15 minutos
    ...
    def __init__(self):
        ...
        self.logger.info(f"⏱️ Sessões configuradas com timeout de {self.SESSION_TIMEOUT_MINUTES} minutos")
        self.logger.info(f"🔧 Limpeza automática a cada {self.CLEANUP_INTERVAL_MINUTES} minutos")
